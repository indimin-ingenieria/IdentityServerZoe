...
namespace Microsoft.AspNetCore.Builder
{
    ...
    public static class IdentityServerApplicationBuilderExtensions
    {
        ...
        internal static void Validate(this IApplicationBuilder app)
        {
            ...
            var logger = loggerFactory.CreateLogger("IdentityServerZoe.Startup");
            logger.LogInformation("Starting IdentityServerZoe version {version}", typeof(IdentityServerZoe.Hosting.IdentityServerMiddleware).Assembly.GetCustomAttribute<AssemblyInformationalVersionAttribute>().InformationalVersion);
