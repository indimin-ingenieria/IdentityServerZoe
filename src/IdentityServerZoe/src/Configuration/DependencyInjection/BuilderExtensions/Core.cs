...
using IdentityServerZoe.Configuration.DependencyInjection;
using IdentityServerZoe.Endpoints;
using IdentityServerZoe.Events;
...
using IdentityServerZoe.Stores.Serialization;
...
using IdentityServerZoe.Hosting.FederatedSignOut;
using IdentityServerZoe.Services.Default;
...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class IdentityServerBuilderExtensionsCore
    {
            ...
            where T : class, IEndpointHandler
        {
            ...
            builder.Services.AddSingleton(new IdentityServerZoe.Hosting.Endpoint(name, path, typeof(T)));
