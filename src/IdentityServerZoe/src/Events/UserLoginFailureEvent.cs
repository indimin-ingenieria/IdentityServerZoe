...
namespace IdentityServerZoe.Events
{
    /// <summary>
    /// Event for failed user authentication
    /// </summary>
    /// <seealso cref="IdentityServerZoe.Events.Event" />
    public class UserLoginFailureEvent : Event
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="T:IdentityServerZoe.Events.UserLoginFailureEvent" /> class.
        /// </summary>
