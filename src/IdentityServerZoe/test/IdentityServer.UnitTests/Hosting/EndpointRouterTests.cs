...
namespace IdentityServer.UnitTests.Hosting
{
    ...
    {
        private Dictionary<string, IdentityServerZoe.Hosting.Endpoint> _pathMap;
        private List<IdentityServerZoe.Hosting.Endpoint> _endpoints;
        private IdentityServerOptions _options;
        private EndpointRouter _subject;

        public EndpointRouterTests()
        {
            _pathMap = new Dictionary<string, IdentityServerZoe.Hosting.Endpoint>();
            _endpoints = new List<IdentityServerZoe.Hosting.Endpoint>();
        ...
        {
            Action a = () => new IdentityServerZoe.Hosting.Endpoint("ep1", "ep1", typeof(MyEndpointHandler));
        ...
        {
            _endpoints.Add(new IdentityServerZoe.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new IdentityServerZoe.Hosting.Endpoint("ep2", "/ep2", typeof(MyOtherEndpointHandler)));
        ...
        {
            _endpoints.Add(new IdentityServerZoe.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new IdentityServerZoe.Hosting.Endpoint("ep1", "/ep1", typeof(MyOtherEndpointHandler)));
        ...
        {
            _endpoints.Add(new IdentityServerZoe.Hosting.Endpoint(EndpointNames.Authorize, "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new IdentityServerZoe.Hosting.Endpoint("ep2", "/ep2", typeof(MyOtherEndpointHandler)));
