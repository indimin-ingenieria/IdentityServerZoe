...
namespace IdentityServer.UnitTests.ResponseHandling.AuthorizeInteractionResponseGenerator
{
    public class AuthorizeInteractionResponseGeneratorTests
    {
        ...
        private IdentityServerZoe.ResponseHandling.AuthorizeInteractionResponseGenerator _subject;
        ...
        {
            _subject = new IdentityServerZoe.ResponseHandling.AuthorizeInteractionResponseGenerator(
                _clock,
