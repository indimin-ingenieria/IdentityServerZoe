...
{
    public class CustomAuthorizeInteractionResponseGenerator : IdentityServerZoe.ResponseHandling.AuthorizeInteractionResponseGenerator
    {
        public CustomAuthorizeInteractionResponseGenerator(ISystemClock clock, ILogger<IdentityServerZoe.ResponseHandling.AuthorizeInteractionResponseGenerator> logger, IConsentService consent, IProfileService profile) : base(clock, logger, consent, profile)
        {
        }
    ...
    public class AuthorizeInteractionResponseGeneratorTests_Custom
    {
        ...
        public AuthorizeInteractionResponseGeneratorTests_Custom()
        {
            _subject = new CustomAuthorizeInteractionResponseGenerator(
                _clock,
                TestLogger.Create<IdentityServerZoe.ResponseHandling.AuthorizeInteractionResponseGenerator>(),
                _mockConsentService,
